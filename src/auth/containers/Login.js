    ...
    render() {
        return (
            <div className="register-container">
                <div>
                    <button className="google-button" onClick={this.handleGoogleLogin}> <span className="google-button__icon">
                        ...
                        <span className="google-button__text">Sign in with Google</span></button>
                </div>
                <div>
                    <h2>LOG IN</h2>
                </div>
